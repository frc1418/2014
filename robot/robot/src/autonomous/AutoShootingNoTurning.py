...
class AutoShootingNoTurning(object):
    ''' sample autonomous program'''
    
    DEFAULT = False
    MODE_NAME = "AutoShootingNoTurning"
    ...
    def update(self, time_elapsed):
        ...
        if self.nextStage:
            ...
            elif self.goalHot == 0 or self.goalHot==-1:                 #maybe generally means sensors aren't working. shoot after 5 seconds
                if self.timer2.Get()>6:
